...
| `-o stream-json` | Not available (verified v1.0.12) |
...
- **AltScreen Tool Confirmations** (v1.0.11+) -- Expanded view (`ctrl+g`) for tool confirmations.
...
- No NDJSON streaming output in verified v1.0.12 -- you get plain text only.
